...
async function fetchVehicalDataByVin(vin, functionLocation, noResults, failed3times, searchBtn, tailoredSuccessMessage, remainingAttempts) {
    ...
    try {
      document.querySelector('.vin-verification-fetching-vin-data').style.display = "block";
      ...
      console.error("Error fetching vehicle data:", error);
        ...
        document.querySelector('.vin-verification-fetching-vin-data').style.display = "none";
